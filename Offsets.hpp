...
// Buttons
constexpr long OFF_IN_ATTACK = 0x073f2818; //[Buttons]->in_attack
constexpr long OFF_IN_JUMP = 0x073f2908; //[Buttons]->in_jump
constexpr long OFF_IN_DUCK = 0x073f29f8; //[Buttons]->in_duck
constexpr long OFFSET_IN_FORWARD = 0x073f2748; //[Buttons]->in_forward
...
constexpr long OFF_VIEW_RENDER = 0x73f1578; //[RecvTable.DT_Player]->ViewRender
...
constexpr long OFF_NAMELIST = 0xc5fec80; //[Miscellaneous]->NameList
constexpr long OFF_YAW = 0x223c - 0x8; //[DataMap.C_Player]=>m_currentFramePlayer.m_ammoPoolCount - 0x8
constexpr long OFF_NAMEINDEX = 0x0578; //[RecvTable.DT_BaseEntity]
