...
constexpr long OFF_LAST_VISIBLE_TIME = 0x1990 + 0x3; //[RecvTable.DT_BaseCombatCharacter]->m_hudInfo_visibilityTestAlwaysPasses + 0x3
...
constexpr long OFF_MODELNAME = 0x0390; //[DataMap.C_BaseEntity]->m_ModelName
constexpr long OFF_NAMELIST = 0xc5fec80; //[Miscellaneous]->NameList
constexpr long OFF_YAW = 0x21f4 - 0x8; //[DataMap.C_Player]=>m_currentFramePlayer.m_ammoPoolCount - 0x8
